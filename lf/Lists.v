...
Proof.
  (* FILL IN HERE *) 
  intros l. induction l. -reflexivity. -simpl. rewrite IHl. reflexivity.
Qed.
...
Proof.
  ...
  -reflexivity. 
  -simpl. 
    assert(H1:forall nl:natlist, rev(nl++[n])=n::(rev nl)).
    {intros nl. induction nl. -reflexivity. -simpl. rewrite IHnl. simpl. reflexivity. }
...
Proof.
  ...
  -reflexivity. 
  - simpl. 
    assert(H1: forall m:nat, m=?m=true). 
...
(* FILL IN HERE *)
(*Infinite: Baz1 (Baz1 (Baz1 (...))), or Baz1 (Baz2 ( Baz1 (...) ) true), and so on *)
