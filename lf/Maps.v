...
Proof.
  (* FILL IN HERE *) 
  intros A m x1 x2 v H. unfold t_update. rewrite <- eqb_string_false_iff in H.
...
Proof.
  ...
  intros xi. destruct (eqb_string x xi).
...
Proof.
  ...
  intros xi. destruct (eqb_stringP x xi).
...
Proof.
  ...
  - rewrite e. unfold t_update. rewrite <- eqb_string_refl. 
    apply eqb_string_false_iff in H. rewrite H. reflexivity.
  - unfold t_update.
    apply not_eq_sym in n. apply eqb_string_false_iff in n. rewrite n.
    reflexivity.
Qed.
(** [] *)
