...
Proof with eauto.
  ...
  (* FILL IN HERE *)
  induction Hs.
  - intros. exists V1, V2. auto.
  - intros. apply IHHs2 in HeqV as [U1 [U2 []]].
    apply IHHs1 in H as [U3 [U4]].
    exists U3, U4.
    destruct H as [[]].
    destruct H. destruct H0.
    split; auto; split.
    + apply (S_Trans V1 U1); auto.
    + apply (S_Trans U4 U2); auto.
  - intros. inversion HeqV.
  - intros. inversion HeqV.
    subst. exists S1, S2. auto.
Qed.
  (** [] *)
