...
Proof. reflexivity. Qed.
Example test_bin_incr3: incr Z = B(Z).
Proof. reflexivity. Qed.
Example test_bin_incr4: bin_to_nat (A (A (A (B Z))) ) =  S (S (S (S (S (S (S (S O))))))).
Proof. reflexivity. Qed.
Example test_bin_incr5: bin_to_nat (B (B (B Z)))  =      S (S (S (S (S (S (S O)))))).
Proof. reflexivity. Qed.
